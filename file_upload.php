<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(!empty($file_name)){
           ...
           $file_extension = strtolower(end($file_extension));//phan duoi extension
           ...
           if(in_array($file_extension, $permitted_extensions)){
                if($file_size <=1000000){
                    ...
                    move_uploaded_file($file_tmp_name,$destination_path);//cat tu thu muc file paste vao thu muc destination
